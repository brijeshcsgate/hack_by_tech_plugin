...
// $like_btn='<a href="javascript:;" class ="wpac-btn wpac-like-btn">Like</a>';
...
$dislike_btn='<a href="javascript:;" class ="wpac-btn wpac-dislike-btn"><i class="fas fa-thumbs-down"></i>'.$dislike_btn_label.'</a>';
